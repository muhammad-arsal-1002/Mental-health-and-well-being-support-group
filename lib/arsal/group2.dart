...
TextStyle get _kTitleTextStyle => const TextStyle(
  color: kDarkGreyText, // Dark grey for titles on bright white background
  fontFamily: _kFontFamily,
  fontSize: 26,
  fontWeight: FontWeight.bold,
  height: 1.25,
...
TextStyle get _kPageTitleTextStyle => const TextStyle(
...
TextStyle get _kItemTitleTextStyle => const TextStyle(
  color: kDarkGreyText, // Dark grey for item titles
  fontFamily: _kFontFamily,
  fontSize: 16,
...
TextStyle get _kItemSubtitleTextStyle => const TextStyle(
  color: kMediumGreyText, // Medium grey for item subtitles
  fontFamily: _kFontFamily,
  fontSize: 14,
...
TextStyle get _kPostContentTextStyle => const TextStyle(
  color: kDarkGreyText, // Dark grey for post content
  fontFamily: _kFontFamily,
  fontSize: 15,
  height: 1.4,
);
...
TextStyle get _kPostMetaTextStyle => const TextStyle(
  color: kMediumGreyText, // Medium grey for post metadata
  fontFamily: _kFontFamily,
  fontSize: 12,
);
...
class _Group2State extends State<Group2> {
  ...
  final List<Map<String, String>> _posts = [
    {
      ...
      'image': 'https://picsum.photos/seed/hike1/400/300',
    },
    {
      'author': 'Jane Smith',
      'time': 'Yesterday',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: kLightBlueAccent.withOpacity(0.2), // Overall screen light background
      appBar: AppBar(
        ...
        title: Text(
          'Group Details',
          style: _kPageTitleTextStyle, // White title
        ),
        centerTitle: false,
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                child: ClipRRect(
                  ...
                  child: _groupCoverImageUrl.isNotEmpty
                    ...
                    errorBuilder: (context, error, stackTrace) => Container(
                      height: 200,
                      color: kLightBlueAccent.withOpacity(0.3), // Placeholder light blue accent
                      child: Center(
                        child: Icon(Icons.photo_library, size: 80, color: kMediumGreyText), // Medium grey icon
                      ),
                    ),
                  )
                      : Container(
              ...
              Text(
                _groupName,
                style: _kTitleTextStyle, // Dark grey text
              ),
              ...
              // Posts Section
              Text('Recent Posts', style: _kSectionTitleTextStyle), // Navy blue title
              const SizedBox(height: 16),
              ListView.builder(
                shrinkWrap: true,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(author, style: _kItemTitleTextStyle.copyWith(
                        fontWeight: FontWeight.bold, fontSize: 14)), // Dark grey text
                    Text(time, style: _kPostMetaTextStyle), // Medium grey text
                  ],
                ),
              ],
            ),
            ...
            Text(
              content,
              style: _kPostContentTextStyle, // Dark grey text
            ),
                  ...
                  errorBuilder: (context, error, stackTrace) => Container(
                    ...
                    child: Center(
                      child: Icon(Icons.broken_image, size: 50,
                          color: kMediumGreyText), // Medium grey icon
                    ),
                  ),
                ),
              ),
  ...
  Widget _buildPostAction(IconData icon, String text) {
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon, size: 18, color: kNavyBlue), // Navy blue icon
            const SizedBox(width: 4),
            Text(text, style: _kPostMetaTextStyle.copyWith(color: kNavyBlue)), // Navy blue text
          ],
        ),
      ),
    );
